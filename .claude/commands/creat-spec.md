---
description: Create a spec file for the next Spnedly feature 
...
1.  'step_number' - zero-padded to 2 digits: -> 02, 11 -> 11
...
- METHOD / path -- description -- access level (public/logged-id)
...
## Templates 
- Creates: list new templates with their path 
...
Save to: .claude/spec/<step_number>-<feature_slug>.md

## Step 5 -- Report to the user
Print a short summary in this exact format:

Spec file: .claude/spec/<step_number>-<feature_slug>.md 
Title: <feature_title>

Then tell the user:
"Review the spec at .claude/spec/<step_number>-<feature_slug>.md 
then enter Plan Mode with Shift+Tab twice to begain implementation."

Do no print the full spech in chat unless explicitly asked. 
